(function () {
  ...
  function resetTemplates() {
    ...
    var css = '<style id="kinogoua_css">'
      ...
      + '.online-prestige__img{position:relative;width:13em;min-height:8.2em;margin-right:1.2em;border-radius:0.4em;overflow:hidden;background:rgba(255,255,255,0.08);flex-shrink:0}'
      + '.online-prestige__img img{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;border-radius:0.4em;opacity:0;transition:opacity 0.3s}'
      + '.online-prestige__img--loaded img{opacity:1}'
      + '.online-prestige__episode-number{position:absolute;top:0;left:0;right:0;bottom:0;display:flex;align-items:center;justify-content:center;font-size:2em;font-weight:bold;color:#fff;text-shadow:0 2px 6px rgba(0,0,0,0.9);pointer-events:none}'
      + '@media screen and (max-width:480px){.online-prestige__img{width:7em;min-height:4.5em}}'
